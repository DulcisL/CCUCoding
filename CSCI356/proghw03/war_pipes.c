...
ToString(int cardValue, int suitValue)
{
    ...
    if (cardValue > 10)
    {
        ...
        {
        case 11:
            strcat(cardRead, "Jack");
        case 12:
            strcat(cardRead, "Queen");
        case 13:
            strcat(cardRead, "King");
        case 14:
            strcat(cardRead, "Ace");
        }
    }
    ...
    if (suitValue != 0)
    {
        ...
        case 1:
            strcat(cardRead, "Clubs");
        case 2:
            strcat(cardRead, "Diamonds");
        case 3:
            strcat(cardRead, "Hearts");
        case 4:
            strcat(cardRead, "Spades");
        }
        return cardRead;
    }
}
