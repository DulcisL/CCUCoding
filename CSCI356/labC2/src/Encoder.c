...
void EncodeTxt(char *input, char *output)
{
    ...
    for (int i = 0; i < length; i++)
    {
        ...
        case 'a':
        case 'A':
            strcpy(&output[index], "10 ");
            break;
        case 'b':
        case 'B':
            strcpy(&output[index], "11 ");
            break;
        case 'c':
        case 'C':
            strcpy(&output[index], "12 ");
            break;
        case 'd':
        case 'D':
            strcpy(&output[index], "13 ");
            break;
        case 'e':
        case 'E':
            strcpy(&output[index], "14 ");
            break;
        case 'f':
        case 'F':
            strcpy(&output[index], "15 ");
            break;
        case 'g':
        case 'G':
            strcpy(&output[index], "16 ");
            break;
        case 'h':
        case 'H':
            strcpy(&output[index], "17 ");
            break;
        case 'i':
        case 'I':
            strcpy(&output[index], "18 ");
            break;
        case 'j':
        case 'J':
            strcpy(&output[index], "19 ");
            break;
        case 'k':
        case 'K':
            strcpy(&output[index], "20 ");
            break;
        case 'l':
        case 'L':
            strcpy(&output[index], "21 ");
            break;
        case 'm':
        case 'M':
            strcpy(&output[index], "22 ");
            break;
        case 'n':
        case 'N':
            strcpy(&output[index], "23 ");
            break;
        case 'o':
        case 'O':
            strcpy(&output[index], "24 ");
            break;
        case 'p':
        case 'P':
            strcpy(&output[index], "25 ");
            break;
        case 'q':
        case 'Q':
            strcpy(&output[index], "26 ");
            break;
        case 'r':
        case 'R':
            strcpy(&output[index], "27 ");
            break;
        case 's':
        case 'S':
            strcpy(&output[index], "28 ");
            break;
        case 't':
        case 'T':
            strcpy(&output[index], "29 ");
            break;
        case 'u':
        case 'U':
            strcpy(&output[index], "30 ");
            break;
        case 'v':
        case 'V':
            strcpy(&output[index], "31 ");
            break;
        case 'w':
        case 'W':
            strcpy(&output[index], "32 ");
            break;
        case 'x':
        case 'X':
            strcpy(&output[index], "33 ");
            break;
        case 'y':
        case 'Y':
            strcpy(&output[index], "34 ");
            break;
        case 'z':
        case 'Z':
            strcpy(&output[index], "35 ");
            break;
        default:
            strcpy(&output[index], "   ");
            break;
