...
No changes to parts functions
Change sliders to buttons
Buttons
    Rotate Base (on/off) - rotates base
    Wave Lower - moves lower arm back and forth with stops (-45 to 45)
    Wave Upper - moves upper arm back and forth with stops (-90 t0 90)

All buttons should freeze in place and compound
*/
...
var waveLower = false;
var waveUpper = false;
var upperDirection = true;
var lowerDirection = true;
